...
$codiguitoSede = filter_input(INPUT_GET, "codigo");
$objSedeController = new SedesController;
$campo = $objSedeController->getSedesXcampo($codiguitoSede);
?>
<!DOCTYPE html>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    if (isset($_GET["msg"])) {
                        ...
                        switch ($msg) {
                            case "1":
                                $msgTxt = "Sede Editada con éxito";
                                break;
                            default:
                                $msgTxt = "Error Editando la sede";
                        }
                    }
                    ?>
                ...
                <div class="card-body">
                    <form id="frmSedeCrear" name="frmSedeCrear" method="post" action="sedes_editar2.php">
                        <input id="codsede" name="codsede" type="hidden" value="<?php echo $campo["codsede"];?>"/>
                        <div class="form-group">
                            <label for="nombresede">Nombre de la sede</label>
                            <input id="nombresede" name="nombresede" type="text" class="form-control form-control-sm col-5" value="<?php echo $campo["nombresede"];?>">
                        </div>
                        <div class="form-group">
